...
- [ ] Associations doc: give keys to author and translator belongsTo assoc, and use this as support for a nested Decodable example (book -> (author -> country) -> (translator -> country)).
