...
class BelongsToOptionalIncludingRequestTests: GRDBTestCase {
    ...
    func testSimplestRequest() throws {
        ...
        try dbQueue.inDatabase { db in
            ...
            assertEqualSQL(lastSQLQuery, "SELECT \"books\".*, \"authors\".* FROM \"books\" LEFT JOIN \"authors\" ON (\"authors\".\"id\" = \"books\".\"authorId\")")
    ...
    func testLeftRequestDerivation() throws {
        ...
        try dbQueue.inDatabase { db in
            do {
                ...
                assertEqualSQL(lastSQLQuery, "SELECT \"books\".*, \"authors\".* FROM \"books\" LEFT JOIN \"authors\" ON (\"authors\".\"id\" = \"books\".\"authorId\") WHERE (\"books\".\"year\" < 2000)")
            ...
            do {
                ...
                assertEqualSQL(lastSQLQuery, "SELECT \"books\".*, \"authors\".* FROM \"books\" LEFT JOIN \"authors\" ON (\"authors\".\"id\" = \"books\".\"authorId\") ORDER BY \"books\".\"title\"")
    ...
    func testRightRequestDerivation() throws {
        ...
        try dbQueue.inDatabase { db in
            do {
                ...
                assertEqualSQL(lastSQLQuery, "SELECT \"books\".*, \"authors\".* FROM \"books\" LEFT JOIN \"authors\" ON ((\"authors\".\"id\" = \"books\".\"authorId\") AND (\"authors\".\"birthYear\" >= 1900))")
            ...
            do {
                ...
                assertEqualSQL(lastSQLQuery, "SELECT \"books\".*, \"authors\".* FROM \"books\" LEFT JOIN \"authors\" ON (\"authors\".\"id\" = \"books\".\"authorId\") ORDER BY \"authors\".\"name\"")
    ...
    func testRecursion() throws {
        ...
        try dbQueue.inDatabase { db in
            do {
                ...
                try assertEqualSQL(db, request, "SELECT \"persons1\".*, \"persons2\".* FROM \"persons\" \"persons1\" LEFT JOIN \"persons\" \"persons2\" ON (\"persons2\".\"id\" = \"persons1\".\"parentId\")")
            }
        }
    }
        ...
        try dbQueue.inDatabase { db in
            do {
                ...
                let request = Book.all()
                    ...
                    .filter(Column("year") < 2000)
                    .including(Book.optionalAuthor)
                try assertEqualSQL(db, request, "SELECT \"b\".*, \"authors\".* FROM \"books\" \"b\" LEFT JOIN \"authors\" ON (\"authors\".\"id\" = \"b\".\"authorId\") WHERE (\"b\".\"year\" < 2000)")
            }
    ...
    func testRightAlias() throws {
        ...
        try dbQueue.inDatabase { db in
            do {
                ...
                try assertEqualSQL(db, request, "SELECT \"books\".*, \"a\".* FROM \"books\" LEFT JOIN \"authors\" \"a\" ON (\"a\".\"id\" = \"books\".\"authorId\") WHERE (\"a\".\"birthYear\" >= 1900) ORDER BY \"a\".\"name\"")
            }
            ...
            do {
                ...
                try assertEqualSQL(db, request, "SELECT \"books\".*, \"a\".* FROM \"books\" LEFT JOIN \"authors\" \"a\" ON ((\"a\".\"id\" = \"books\".\"authorId\") AND (\"a\".\"birthYear\" >= 1900)) ORDER BY \"a\".\"name\"")
            }
        }
    }
    ...
    func testLockedAlias() throws {
        ...
        try dbQueue.inDatabase { db in
            do {
                ...
                try assertEqualSQL(db, request, "SELECT \"AUTHORS\".*, \"authors1\".* FROM \"books\" \"AUTHORS\" LEFT JOIN \"authors\" \"authors1\" ON (\"authors1\".\"id\" = \"AUTHORS\".\"authorId\")")
            }
            
            do {
                // alias right
                let request = Book.including(Book.optionalAuthor.aliased("BOOKS"))
                try assertEqualSQL(db, request, "SELECT \"books1\".*, \"BOOKS\".* FROM \"books\" \"books1\" LEFT JOIN \"authors\" \"BOOKS\" ON (\"BOOKS\".\"id\" = \"books1\".\"authorId\")")
            }
        }
    }
