...
class AssociationParallelRowScopesTests: GRDBTestCase {
    ...
    func testDefaultScopeParallelTwoIncludingIncluding() throws {
        ...
        do {
            ...
            XCTAssertEqual(rows[0].scopeNames, ["b", "d"])
            XCTAssertEqual(rows[0].scoped(on: "b")!, ["id":1, "name":"b1"])
            XCTAssertEqual(rows[0].scoped(on: "d")!, ["id":1, "name":"d1"])
            
            XCTAssertEqual(rows[1].unscoped, ["id":3, "bid":2, "did":1, "name":"a3"])
            XCTAssertEqual(rows[1].scopeNames, ["b", "d"])
            XCTAssertEqual(rows[1].scoped(on: "b")!, ["id":2, "name":"b2"])
            XCTAssertEqual(rows[1].scoped(on: "d")!, ["id":1, "name":"d1"])
        }
        do {
            ...
            XCTAssertEqual(rows[1].scoped(on: "d")!, ["id":nil, "name":nil])
            
            XCTAssertEqual(rows[2].unscoped, ["id":3, "bid":2, "did":1, "name":"a3"])
            XCTAssertEqual(rows[2].scopeNames, ["b", "d"])
            XCTAssertEqual(rows[2].scoped(on: "b")!, ["id":2, "name":"b2"])
            XCTAssertEqual(rows[2].scoped(on: "d")!, ["id":1, "name":"d1"])
            
            XCTAssertEqual(rows[3].unscoped, ["id":4, "bid":2, "did":nil, "name":"a4"])
            XCTAssertEqual(rows[3].scopeNames, ["b", "d"])
            XCTAssertEqual(rows[3].scoped(on: "b")!, ["id":2, "name":"b2"])
            XCTAssertEqual(rows[3].scoped(on: "d")!, ["id":nil, "name":nil])
        }
        do {
            ...
            XCTAssertEqual(rows[2].scopeNames, ["b", "d"])
            XCTAssertEqual(rows[2].scoped(on: "b")!, ["id":nil, "name":nil])
            XCTAssertEqual(rows[2].scoped(on: "d")!, ["id":1, "name":"d1"])
        }
        do {
            ...
            XCTAssertEqual(rows[4].scopeNames, ["b", "d"])
            XCTAssertEqual(rows[4].scoped(on: "b")!, ["id":nil, "name":nil])
            XCTAssertEqual(rows[4].scoped(on: "d")!, ["id":1, "name":"d1"])
            
            XCTAssertEqual(rows[5].unscoped, ["id":6, "bid":nil, "did":nil, "name":"a6"])
            XCTAssertEqual(rows[5].scopeNames, ["b", "d"])
            XCTAssertEqual(rows[5].scoped(on: "b")!, ["id":nil, "name":nil])
            XCTAssertEqual(rows[5].scoped(on: "d")!, ["id":nil, "name":nil])
        }
        do {
            ...
            XCTAssertEqual(rows[0].scopeNames, ["a", "c"])
            XCTAssertEqual(rows[0].scoped(on: "a")!, ["id":1, "bid":1, "did":1, "name":"a1"])
            XCTAssertEqual(rows[0].scoped(on: "c")!, ["id":1, "bid":1, "name":"c1"])
            
            XCTAssertEqual(rows[1].unscoped, ["id":1, "name":"b1"])
            XCTAssertEqual(rows[1].scopeNames, ["a", "c"])
            XCTAssertEqual(rows[1].scoped(on: "a")!, ["id":2, "bid":1, "did":nil, "name":"a2"])
            XCTAssertEqual(rows[1].scoped(on: "c")!, ["id":1, "bid":1, "name":"c1"])
        }
        do {
            ...
            XCTAssertEqual(rows[2].scopeNames, ["a", "c"])
            XCTAssertEqual(rows[2].scoped(on: "a")!, ["id":3, "bid":2, "did":1, "name":"a3"])
            XCTAssertEqual(rows[2].scoped(on: "c")!, ["id":nil, "bid":nil, "name":nil])
            
            XCTAssertEqual(rows[3].unscoped, ["id":2, "name":"b2"])
            XCTAssertEqual(rows[3].scopeNames, ["a", "c"])
            XCTAssertEqual(rows[3].scoped(on: "a")!, ["id":4, "bid":2, "did":nil, "name":"a4"])
            XCTAssertEqual(rows[3].scoped(on: "c")!, ["id":nil, "bid":nil, "name":nil])
        }
        do {
        ...
        do {
            ...
            XCTAssertEqual(rows[4].scopeNames, ["a", "c"])
            XCTAssertEqual(rows[4].scoped(on: "a")!, ["id":nil, "bid":nil, "did":nil, "name":nil])
            XCTAssertEqual(rows[4].scoped(on: "c")!, ["id":nil, "bid":nil, "name":nil])
        }
    }
    ...
    func testDefaultScopeParallelTwoIncludingJoining() throws {
        ...
        do {
            ...
            XCTAssertEqual(rows[4].unscoped, ["id":5, "bid":nil, "did":1, "name":"a5"])
            XCTAssertEqual(rows[4].scopeNames, ["b"])
            XCTAssertEqual(rows[4].scoped(on: "b")!, ["id":nil, "name":nil])
            
            XCTAssertEqual(rows[5].unscoped, ["id":6, "bid":nil, "did":nil, "name":"a6"])
            XCTAssertEqual(rows[5].scopeNames, ["b"])
            XCTAssertEqual(rows[5].scoped(on: "b")!, ["id":nil, "name":nil])
        }
        do {
            ...
            XCTAssertEqual(rows[0].unscoped, ["id":1, "name":"b1"])
            XCTAssertEqual(rows[0].scopeNames, ["a"])
            XCTAssertEqual(rows[0].scoped(on: "a")!, ["id":1, "bid":1, "did":1, "name":"a1"])
            
            XCTAssertEqual(rows[1].unscoped, ["id":1, "name":"b1"])
            XCTAssertEqual(rows[1].scopeNames, ["a"])
            XCTAssertEqual(rows[1].scoped(on: "a")!, ["id":2, "bid":1, "did":nil, "name":"a2"])
        }
        do {
            ...
            XCTAssertEqual(rows[2].unscoped, ["id":2, "name":"b2"])
            XCTAssertEqual(rows[2].scopeNames, ["a"])
            XCTAssertEqual(rows[2].scoped(on: "a")!, ["id":3, "bid":2, "did":1, "name":"a3"])
            
            XCTAssertEqual(rows[3].unscoped, ["id":2, "name":"b2"])
            XCTAssertEqual(rows[3].scopeNames, ["a"])
            XCTAssertEqual(rows[3].scoped(on: "a")!, ["id":4, "bid":2, "did":nil, "name":"a4"])
        }
        do {
        ...
        do {
            ...
            XCTAssertEqual(rows[4].unscoped, ["id":3, "name":"b3"])
            XCTAssertEqual(rows[4].scopeNames, ["a"])
            XCTAssertEqual(rows[4].scoped(on: "a")!, ["id":nil, "bid":nil, "did":nil, "name":nil])
        }
    }
    ...
    func testDefaultScopeParallelTwoJoiningIncluding() throws {
        ...
        do {
            ...
            XCTAssertEqual(rows[0].unscoped, ["id":1, "bid":1, "did":1, "name":"a1"])
            XCTAssertEqual(rows[0].scopeNames, ["d"])
            XCTAssertEqual(rows[0].scoped(on: "d")!, ["id":1, "name":"d1"])
            
            XCTAssertEqual(rows[1].unscoped, ["id":3, "bid":2, "did":1, "name":"a3"])
            XCTAssertEqual(rows[1].scopeNames, ["d"])
            XCTAssertEqual(rows[1].scoped(on: "d")!, ["id":1, "name":"d1"])
        }
        do {
            ...
            XCTAssertEqual(rows[2].unscoped, ["id":3, "bid":2, "did":1, "name":"a3"])
            XCTAssertEqual(rows[2].scopeNames, ["d"])
            XCTAssertEqual(rows[2].scoped(on: "d")!, ["id":1, "name":"d1"])
            
            XCTAssertEqual(rows[3].unscoped, ["id":4, "bid":2, "did":nil, "name":"a4"])
            XCTAssertEqual(rows[3].scopeNames, ["d"])
            XCTAssertEqual(rows[3].scoped(on: "d")!, ["id":nil, "name":nil])
        }
        do {
        ...
        do {
            ...
            XCTAssertEqual(rows[4].unscoped, ["id":5, "bid":nil, "did":1, "name":"a5"])
            XCTAssertEqual(rows[4].scopeNames, ["d"])
            XCTAssertEqual(rows[4].scoped(on: "d")!, ["id":1, "name":"d1"])
            
            XCTAssertEqual(rows[5].unscoped, ["id":6, "bid":nil, "did":nil, "name":"a6"])
            XCTAssertEqual(rows[5].scopeNames, ["d"])
            XCTAssertEqual(rows[5].scoped(on: "d")!, ["id":nil, "name":nil])
        }
        do {
        ...
        do {
            ...
            XCTAssertEqual(rows[3].unscoped, ["id":2, "name":"b2"])
            XCTAssertEqual(rows[3].scopeNames, ["c"])
            XCTAssertEqual(rows[3].scoped(on: "c")!, ["id":nil, "bid":nil, "name":nil])
        }
        do {
        ...
        do {
            ...
            XCTAssertEqual(rows[4].unscoped, ["id":3, "name":"b3"])
            XCTAssertEqual(rows[4].scopeNames, ["c"])
            XCTAssertEqual(rows[4].scoped(on: "c")!, ["id":nil, "bid":nil, "name":nil])
        }
    }
    ...
    func testDefaultScopeParallelTwoJoiningJoining() throws {
        ...
        do {
            ...
            XCTAssertEqual(rows[4].unscoped, ["id":5, "bid":nil, "did":1, "name":"a5"])
            XCTAssertTrue(rows[4].scopeNames.isEmpty)
            
            XCTAssertEqual(rows[5].unscoped, ["id":6, "bid":nil, "did":nil, "name":"a6"])
            XCTAssertTrue(rows[5].scopeNames.isEmpty)
        }
        do {
    ...
    func testCustomScopeParallelTwoIncludingIncluding() throws {
        ...
        do {
            ...
            XCTAssertEqual(rows[0].unscoped, ["id":1, "bid":1, "did":1, "name":"a1"])
            XCTAssertEqual(rows[0].scopeNames, ["customB", "customD"])
            XCTAssertEqual(rows[0].scoped(on: "customB")!, ["id":1, "name":"b1"])
            XCTAssertEqual(rows[0].scoped(on: "customD")!, ["id":1, "name":"d1"])
            
            XCTAssertEqual(rows[1].unscoped, ["id":3, "bid":2, "did":1, "name":"a3"])
            XCTAssertEqual(rows[1].scopeNames, ["customB", "customD"])
            XCTAssertEqual(rows[1].scoped(on: "customB")!, ["id":2, "name":"b2"])
            XCTAssertEqual(rows[1].scoped(on: "customD")!, ["id":1, "name":"d1"])
        }
        do {
            ...
            XCTAssertEqual(rows[1].unscoped, ["id":2, "bid":1, "did":nil, "name":"a2"])
            XCTAssertEqual(rows[1].scopeNames, ["customB", "customD"])
            XCTAssertEqual(rows[1].scoped(on: "customB")!, ["id":1, "name":"b1"])
            XCTAssertEqual(rows[1].scoped(on: "customD")!, ["id":nil, "name":nil])
            
            XCTAssertEqual(rows[2].unscoped, ["id":3, "bid":2, "did":1, "name":"a3"])
            XCTAssertEqual(rows[2].scopeNames, ["customB", "customD"])
            XCTAssertEqual(rows[2].scoped(on: "customB")!, ["id":2, "name":"b2"])
            XCTAssertEqual(rows[2].scoped(on: "customD")!, ["id":1, "name":"d1"])
            
            XCTAssertEqual(rows[3].unscoped, ["id":4, "bid":2, "did":nil, "name":"a4"])
            XCTAssertEqual(rows[3].scopeNames, ["customB", "customD"])
            XCTAssertEqual(rows[3].scoped(on: "customB")!, ["id":2, "name":"b2"])
            XCTAssertEqual(rows[3].scoped(on: "customD")!, ["id":nil, "name":nil])
        }
        do {
            ...
            XCTAssertEqual(rows[2].unscoped, ["id":5, "bid":nil, "did":1, "name":"a5"])
            XCTAssertEqual(rows[2].scopeNames, ["customB", "customD"])
            XCTAssertEqual(rows[2].scoped(on: "customB")!, ["id":nil, "name":nil])
            XCTAssertEqual(rows[2].scoped(on: "customD")!, ["id":1, "name":"d1"])
        }
        do {
            ...
            XCTAssertEqual(rows[4].unscoped, ["id":5, "bid":nil, "did":1, "name":"a5"])
            XCTAssertEqual(rows[4].scopeNames, ["customB", "customD"])
            XCTAssertEqual(rows[4].scoped(on: "customB")!, ["id":nil, "name":nil])
            XCTAssertEqual(rows[4].scoped(on: "customD")!, ["id":1, "name":"d1"])
            
            XCTAssertEqual(rows[5].unscoped, ["id":6, "bid":nil, "did":nil, "name":"a6"])
            XCTAssertEqual(rows[5].scopeNames, ["customB", "customD"])
            XCTAssertEqual(rows[5].scoped(on: "customB")!, ["id":nil, "name":nil])
            XCTAssertEqual(rows[5].scoped(on: "customD")!, ["id":nil, "name":nil])
        }
        do {
            ...
            XCTAssertEqual(rows[0].unscoped, ["id":1, "name":"b1"])
            XCTAssertEqual(rows[0].scopeNames, ["customA", "customC"])
            XCTAssertEqual(rows[0].scoped(on: "customA")!, ["id":1, "bid":1, "did":1, "name":"a1"])
            XCTAssertEqual(rows[0].scoped(on: "customC")!, ["id":1, "bid":1, "name":"c1"])
            
            XCTAssertEqual(rows[1].unscoped, ["id":1, "name":"b1"])
            XCTAssertEqual(rows[1].scopeNames, ["customA", "customC"])
            XCTAssertEqual(rows[1].scoped(on: "customA")!, ["id":2, "bid":1, "did":nil, "name":"a2"])
            XCTAssertEqual(rows[1].scoped(on: "customC")!, ["id":1, "bid":1, "name":"c1"])
        }
        do {
            ...
            XCTAssertEqual(rows[2].unscoped, ["id":2, "name":"b2"])
            XCTAssertEqual(rows[2].scopeNames, ["customA", "customC"])
            XCTAssertEqual(rows[2].scoped(on: "customA")!, ["id":3, "bid":2, "did":1, "name":"a3"])
            XCTAssertEqual(rows[2].scoped(on: "customC")!, ["id":nil, "bid":nil, "name":nil])
            
            XCTAssertEqual(rows[3].unscoped, ["id":2, "name":"b2"])
            XCTAssertEqual(rows[3].scopeNames, ["customA", "customC"])
            XCTAssertEqual(rows[3].scoped(on: "customA")!, ["id":4, "bid":2, "did":nil, "name":"a4"])
            XCTAssertEqual(rows[3].scoped(on: "customC")!, ["id":nil, "bid":nil, "name":nil])
        }
        do {
        ...
        do {
            ...
            XCTAssertEqual(rows[4].unscoped, ["id":3, "name":"b3"])
            XCTAssertEqual(rows[4].scopeNames, ["customA", "customC"])
            XCTAssertEqual(rows[4].scoped(on: "customA")!, ["id":nil, "bid":nil, "did":nil, "name":nil])
            XCTAssertEqual(rows[4].scoped(on: "customC")!, ["id":nil, "bid":nil, "name":nil])
        }
    }
    ...
    func testCustomScopeParallelTwoIncludingJoining() throws {
        ...
        do {
            ...
            XCTAssertEqual(rows[0].unscoped, ["id":1, "bid":1, "did":1, "name":"a1"])
            XCTAssertEqual(rows[0].scopeNames, ["customB"])
            XCTAssertEqual(rows[0].scoped(on: "customB")!, ["id":1, "name":"b1"])
            
            XCTAssertEqual(rows[1].unscoped, ["id":3, "bid":2, "did":1, "name":"a3"])
            XCTAssertEqual(rows[1].scopeNames, ["customB"])
            XCTAssertEqual(rows[1].scoped(on: "customB")!, ["id":2, "name":"b2"])
        }
        do {
            ...
            XCTAssertEqual(rows[2].unscoped, ["id":3, "bid":2, "did":1, "name":"a3"])
            XCTAssertEqual(rows[2].scopeNames, ["customB"])
            XCTAssertEqual(rows[2].scoped(on: "customB")!, ["id":2, "name":"b2"])
            
            XCTAssertEqual(rows[3].unscoped, ["id":4, "bid":2, "did":nil, "name":"a4"])
            XCTAssertEqual(rows[3].scopeNames, ["customB"])
            XCTAssertEqual(rows[3].scoped(on: "customB")!, ["id":2, "name":"b2"])
        }
        do {
        ...
        do {
            ...
            XCTAssertEqual(rows[4].unscoped, ["id":5, "bid":nil, "did":1, "name":"a5"])
            XCTAssertEqual(rows[4].scopeNames, ["customB"])
            XCTAssertEqual(rows[4].scoped(on: "customB")!, ["id":nil, "name":nil])
            
            XCTAssertEqual(rows[5].unscoped, ["id":6, "bid":nil, "did":nil, "name":"a6"])
            XCTAssertEqual(rows[5].scopeNames, ["customB"])
            XCTAssertEqual(rows[5].scoped(on: "customB")!, ["id":nil, "name":nil])
        }
        do {
            ...
            XCTAssertEqual(rows[0].unscoped, ["id":1, "name":"b1"])
            XCTAssertEqual(rows[0].scopeNames, ["customA"])
            XCTAssertEqual(rows[0].scoped(on: "customA")!, ["id":1, "bid":1, "did":1, "name":"a1"])
            
            XCTAssertEqual(rows[1].unscoped, ["id":1, "name":"b1"])
            XCTAssertEqual(rows[1].scopeNames, ["customA"])
            XCTAssertEqual(rows[1].scoped(on: "customA")!, ["id":2, "bid":1, "did":nil, "name":"a2"])
        }
        do {
            ...
            XCTAssertEqual(rows[2].unscoped, ["id":2, "name":"b2"])
            XCTAssertEqual(rows[2].scopeNames, ["customA"])
            XCTAssertEqual(rows[2].scoped(on: "customA")!, ["id":3, "bid":2, "did":1, "name":"a3"])
            
            XCTAssertEqual(rows[3].unscoped, ["id":2, "name":"b2"])
            XCTAssertEqual(rows[3].scopeNames, ["customA"])
            XCTAssertEqual(rows[3].scoped(on: "customA")!, ["id":4, "bid":2, "did":nil, "name":"a4"])
        }
        do {
        ...
        do {
            ...
            XCTAssertEqual(rows[4].unscoped, ["id":3, "name":"b3"])
            XCTAssertEqual(rows[4].scopeNames, ["customA"])
            XCTAssertEqual(rows[4].scoped(on: "customA")!, ["id":nil, "bid":nil, "did":nil, "name":nil])
        }
    }
    ...
    func testCustomScopeParallelTwoJoiningIncluding() throws {
        ...
        do {
            ...
            XCTAssertEqual(rows[0].unscoped, ["id":1, "bid":1, "did":1, "name":"a1"])
            XCTAssertEqual(rows[0].scopeNames, ["customD"])
            XCTAssertEqual(rows[0].scoped(on: "customD")!, ["id":1, "name":"d1"])
            
            XCTAssertEqual(rows[1].unscoped, ["id":3, "bid":2, "did":1, "name":"a3"])
            XCTAssertEqual(rows[1].scopeNames, ["customD"])
            XCTAssertEqual(rows[1].scoped(on: "customD")!, ["id":1, "name":"d1"])
        }
        do {
            ...
            XCTAssertEqual(rows[2].unscoped, ["id":3, "bid":2, "did":1, "name":"a3"])
            XCTAssertEqual(rows[2].scopeNames, ["customD"])
            XCTAssertEqual(rows[2].scoped(on: "customD")!, ["id":1, "name":"d1"])
            
            XCTAssertEqual(rows[3].unscoped, ["id":4, "bid":2, "did":nil, "name":"a4"])
            XCTAssertEqual(rows[3].scopeNames, ["customD"])
            XCTAssertEqual(rows[3].scoped(on: "customD")!, ["id":nil, "name":nil])
        }
        do {
        ...
        do {
            ...
            XCTAssertEqual(rows[4].unscoped, ["id":5, "bid":nil, "did":1, "name":"a5"])
            XCTAssertEqual(rows[4].scopeNames, ["customD"])
            XCTAssertEqual(rows[4].scoped(on: "customD")!, ["id":1, "name":"d1"])
            
            XCTAssertEqual(rows[5].unscoped, ["id":6, "bid":nil, "did":nil, "name":"a6"])
            XCTAssertEqual(rows[5].scopeNames, ["customD"])
            XCTAssertEqual(rows[5].scoped(on: "customD")!, ["id":nil, "name":nil])
        }
        do {
            ...
            XCTAssertEqual(rows[0].unscoped, ["id":1, "name":"b1"])
            XCTAssertEqual(rows[0].scopeNames, ["customC"])
            XCTAssertEqual(rows[0].scoped(on: "customC")!, ["id":1, "bid":1, "name":"c1"])
            
            XCTAssertEqual(rows[1].unscoped, ["id":1, "name":"b1"])
            XCTAssertEqual(rows[1].scopeNames, ["customC"])
            XCTAssertEqual(rows[1].scoped(on: "customC")!, ["id":1, "bid":1, "name":"c1"])
        }
        do {
            ...
            XCTAssertEqual(rows[2].unscoped, ["id":2, "name":"b2"])
            XCTAssertEqual(rows[2].scopeNames, ["customC"])
            XCTAssertEqual(rows[2].scoped(on: "customC")!, ["id":nil, "bid":nil, "name":nil])
            
            XCTAssertEqual(rows[3].unscoped, ["id":2, "name":"b2"])
            XCTAssertEqual(rows[3].scopeNames, ["customC"])
            XCTAssertEqual(rows[3].scoped(on: "customC")!, ["id":nil, "bid":nil, "name":nil])
        }
        do {
        ...
        do {
            ...
            XCTAssertEqual(rows[4].unscoped, ["id":3, "name":"b3"])
            XCTAssertEqual(rows[4].scopeNames, ["customC"])
            XCTAssertEqual(rows[4].scoped(on: "customC")!, ["id":nil, "bid":nil, "name":nil])
        }
    }
